...
CALLSHEET_STRUCTURE = [
    ...
    {"group": "RUN GAME", "name": "Gap Scheme", "plays": [
        {"label": "BREEZE", "warp": True, "call": "BREEZE",
         "note": "Moved here from Midzone per Matt -- BREEZE is a Gap run, not Midzone."},
    ...
    # ── 3RD & 4TH DOWN (placed before SITUATIONAL per Matt's ordering) ────
    {"group": "3RD & 4TH DOWN", "name": "2nd & Long (7+)", "plays": []},
    {"group": "3RD & 4TH DOWN", "name": "3rd & 1 (1.2/gm)", "plays": [
    ...
    {"group": "3RD & 4TH DOWN", "name": "3rd & 2 (1.8/gm)", "plays": [
        {"label": "SLING Z-SLAB 0/1 ENTER Z-CRAPPY", "warp": False,
         "lt": "SLING LT Z-SLAB 0 ENTER Z-CRAPPY", "rt": "SLING RT Z-SLAB 1 ENTER Z-CRAPPY"},
        {"label": "BOBCAT", "warp": True, "call": "BOBCAT"},
        {"label": "UNDER THING NASTY Z-SHORT 0/1 CAPTAIN", "warp": False,
    ...
    {"group": "3RD & 4TH DOWN", "name": "3rd & 3-5 (3.4/gm)", "plays": [
